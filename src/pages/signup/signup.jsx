...
const SignUp = () => {
  ...
  <form onSubmit={handleSubmit}>
    ...
    <div>
		...
		<input type='text' placeholder='Your Name' className='w-full input input-bordered  h-10' value={inputs.fullName}
    ...
    <Link to={'/login'} className='text-sm hover:underline hover:text-amber-400 inline-block text-gray-100'>
